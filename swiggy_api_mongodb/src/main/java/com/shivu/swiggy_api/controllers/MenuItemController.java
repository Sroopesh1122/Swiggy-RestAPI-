...
public class MenuItemController {
	...
	@PreAuthorize("hasRole('RESTAURANT')")
	public MenuItem getMenuItem (@AuthenticationPrincipal RestaurantDetails restaurantDetails,@PathVariable String menuId)
	{
		if(restaurantDetails ==null)
		{
			throw new RestaurantException("Unauthorized");
	...
	@GetMapping("/")
	public ResponseEntity<?> getMenuItems(@RequestParam(required = false) String q ,@RequestParam(required=false) String rId  , @RequestParam Integer page , @RequestParam Integer limit)
	{
		page = page-1;
	...
	@GetMapping("/{id}")
	public ResponseEntity<?> getMenuItemWithRestaurantDetails(@PathVariable(name = "id") String itemId)
	{
