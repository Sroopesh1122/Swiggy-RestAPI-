...
public class OrderController {
	...
	public ResponseEntity<?> pickOrder(@AuthenticationPrincipal DeliveryDetails deliveryDetails, @RequestBody PickOrderRequest request){
		...
		String emailBody = "Dear "+user.getName()+",\r\n"
				...
				+ "\r\n"
				+ "🍽 Order Details:\r\n"
				+ "Food Item: "+findOrder.getOrderItems().get(0).getMenuItem().getName()+"\r\n"
				+ "Restaurant: "+findOrder.getOrderItems().get(0).getMenuItem().getRestaurant().getName()+"\r\n"
				+ "Total Amount: "+findOrder.getTotalAmount()+"\r\n"
				+ "🚴‍♂️ Delivery Details:\r\n"
				+ "Delivery Partner: "+deliveryPartner.getName()+"\r\n"
